...
class InlineGateway(unittest.TestCase):
    ...
    def test_mcp_endpoint_lists_and_calls_tools(self):
        ...
        self.assertEqual([t["name"] for t in body["result"]["tools"]],
                         ["research_find", "research_resolve", "research_enrich", "research_files", "research_download",
                          "research_data", "research_catalog", "research_sources", "research_status", "research_job",
                          "research_batch"])
